...
import { UpdateTrainingSessions } from '../../../src/video/application/usecase/updateTrainingSessions.usecase';
...
describe('UpdateTrainingSessions Use Case', () => {
  ...
  it('should add a training session to a client', async () => {
    ...
    const updatedUser = await useCaseUpdateTrainingSessions.execute(user.id, [
      newTrainingSession,
    ]);
